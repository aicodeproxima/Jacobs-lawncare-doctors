...
const ResidentialSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/garden_path_detail.jpg"
          alt="Garden path with mulch and shrubs"
      ...
      <div className="relative z-10 min-h-[80vh] lg:min-h-screen flex items-center px-6 lg:px-[6vw] py-16">
        <div ref={textBlockRef} className="max-w-sm md:max-w-md lg:max-w-lg">
          ...
          <p className="text-cream/80 text-sm md:text-base lg:text-lg leading-relaxed mb-6 lg:mb-8">
            We specialize in residential properties—townhomes, single-family homes, and estates—so we protect your landscaping, your time, and your peace of mind.
          </p>
        ...
        <div
          ref={imageCardRef}
          className="hidden lg:block absolute right-[6vw] top-1/2 -translate-y-1/2 w-[38vw] h-[50vh] shadow-card overflow-hidden"
        >
          <img
            src="/garden_flowers_close.jpg"
